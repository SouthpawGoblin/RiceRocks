...
class BuildExe:
    def __init__(self):
        ...
        #Auhor of program
        self.author_name = "Roger Qi"
        self.author_email = "qiyinzhe@qq.com"
        self.copyright = "Copyright (c) 2015 Roger Qi."
 
        #Description
        self.project_description = "A pygame implementation of RiceRocks"
